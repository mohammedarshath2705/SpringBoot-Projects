package com.geeksforgeeks.DigitalLibrary.util;
...
public class JwtUtil {
    ...
    private static final String SECRET_KEY = "my-secret-key-my-secret-key-my-secret-key"; // Ensure this is a secure key
